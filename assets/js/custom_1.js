...
var bs,blog = {
  ...
  bindUIActions : function(){
    ...
    bs.blogMore.on('click',function(e){
        ...
        var $newItems = $('<div class="blog-item diary expo daily"><div class="inside"><img src="../assets/img/blog/posts/thumb/the_cm/01.jpg" alt="image" class="img-responsive"><div class="blog-item-contents"><h3><a href="ajax_pages/single-post.html" class="upstream-post">Union Minister for Railways, Shri. Suresh Prabhu, meets Chief Minister Shri. K. Chandrasekhar Rao in Hyderabad</a></h3><div class="post-meta"><div class="post-author"><i class="fa fa-edit"></i>Edit</div><div class="post-date"><i class="fa fa-calendar"></i>2015/1/20</div><div class="post-cat"><i class="fa fa-folder"></i>Folder</div></div><div class="post-intro">Honourable Chief Minister Shri. K. Chandrasekhar Rao has brought to the notice of Union Minister for Railways Shri. Suresh Prabhu various pending railway projects and several other issues pending with the railways.</div><div class="post-more"><a href="ajax_pages/single-post.html" class="upstream-post">read more</a></div></div></div></div><div class="blog-item diary expo daily"><div class="inside"><img src="../assets/img/blog/posts/thumb/the_cm/02.jpg" alt="image" class="img-responsive"><div class="blog-item-contents"><h3><a href="ajax_pages/single-post.html" class="upstream-post">Hyderbad will host World Congress on Information Technology in February 2018.</a></h3><div class="post-meta"><div class="post-author"><i class="fa fa-edit"></i>Edit</div><div class="post-date"><i class="fa fa-calendar"></i>2015/1/20</div><div class="post-cat"><i class="fa fa-folder"></i>Folder</div></div><div class="post-intro">Hon. CM KCR has agreed to the request of Sri. R. Chandrashekhar, President NASSCOM and Sri BVR Mohan Reddy, Vice Chairman NASSCOM to host the ‘World Congress on Information Technology’ (WCIT) in Hyderabad in February 2018.</div><div class="post-more"><a href="ajax_pages/single-post.html" class="upstream-post">read more</a></div></div></div></div>');
