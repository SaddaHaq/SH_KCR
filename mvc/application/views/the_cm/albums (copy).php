        ...
        <div class="container">
            <div class="main">
                <header class="clearfix">
                    <h1>KCR Warngal visit<span>KCR Warngal visit</span></h1>
...
-->                        <li>
                        ...
                        <li>
                            <div data-alt="img03" data-description="<h3>Sky high</h3>" data-max-width="1800" data-max-height="1350">
                                <div data-src="../assets/img/gallery/the_cm/KCR-visit-warangal/KCR-visit-warangal-6.jpg" data-min-width="200"></div>
                                <noscript>
                                <img src="images/xsmall/3.jpg" alt="img03"/>
                                </noscript>
                            </div>
